...
* In der Verwaltung ist die Liste der Redner im Dropdown für das Auswahlfeld nicht mehr auf 10 beschränkt.
* Prozess für Erstbenutzer verbessert, Wizard aus den Einstellungen heraus aufrufbar
* Kleine Fehler behoben (Zugriffsprobleme beim lesen der Einstellungen)
* Unter Mein Plan - Redner Suchen wird der DropDown für die Termine auf die max Monate für die Rednersuche in den Einstellungen gefiltert.
...
### Version 0.9.11 (05.08.2020) ###

Hotfix: Fehlertoleranterer Updatemechanismus.

### Version 0.9.10 (24.07.2020) ###
