    ...
    public static class Initialize
    {
        ...
        public static List<Talk> LoadDefaultTalks()
        {
            ...
            var v = new List<Talk>(200)
            {
                ...
                new Talk(26, "Bin ich Gott wichtig?"),
                ...
                new Talk(34, "Werde ich das Zeichen zum Überleben bekommen?", false),
                ...
                new Talk(40, "Was die nahe Zukunft bringt"),
                ...
                new Talk(84, "Dem entgehen, was dieser Welt bevorsteht", false),
                new Talk(85, "Eine gute Botschaft in einer gewalttätigen Welt", false),
                new Talk(86, "Welche Gebete erhört Gott?"),
                new Talk(87, "Was für ein Verhältnis habe ich zu Gott?", false),
                ...
                new Talk(92, "Die Rolle der Religion im Weltgeschehen", false),
                new Talk(93, "Naturkatastrophen – werden sie jemals enden?"),
                new Talk(94, "Die wahre Religion stillt die Bedürfnisse der menschlichen Gesellschaft", false),
                new Talk(95, "Spiritismus – warum gefährlich?"),
                new Talk(96, "Welche Zukunft hat die Religion? "),
                new Talk(97, "Sich in einer schlechten Welt nichts zuschulden kommen lassen", false),
                ...
                new Talk(105, "In allen unseren Prüfungen Trost finden", false),
                new Talk(106, "Die Zerstörung der Erde wird von Gott bestraft",false),
                new Talk(107, "Was bringt mir ein gut geschultes Gewissen?"),
                new Talk(108, "Wir können zuversichtlich in die Zukunft schauen!"),
                new Talk(109, "Das Königreich Gottes ist nah", false),
                ...
                new Talk(117, "Wie man das Böse mit dem Guten besiegen kann", false),
                new Talk(118, "Jugendlichen gegenüber so eingestellt sein wie Jehova"),
                new Talk(119, "Warum es gut ist, als Christ kein Teil der Welt zu sein", false),
                new Talk(120, "Warum man sich jetzt Gottes Herrschaft unterordnen sollte", false),
                ...
                new Talk(124, "Stammt die Bibel wirklich von Gott?", false),
                new Talk(125, "Warum die Menschheit ein Lösegeld benötigt"),
                new Talk(126, "Wer kann gerettet werden?", false),
                ...
                new Talk(139, "Göttliche Weisheit in einer wissenschaftlich orientierten Welt", false),
                new Talk(140, "Jesus Christus - wer er wirklich ist"),
                new Talk(141, "Das Seufzen der Menschheit - wann wird es enden?", false),
                new Talk(142, "Warum sollten wir bei Jehova Zuflucht suchen?"),
                new Talk(143, "Auf den Gott allen Trostes vertrauen"),
                new Talk(144, "Eine loyale Versammlung unter der Führung Christi", false),
                new Talk(145, "Wer ist wie Jehova, unser Gott?", false),
                new Talk(146, "Bildung zur Ehre Jehovas nutzen"),
                new Talk(147, "Vertrauen wir auf die rettende Macht Jehovas"),
                new Talk(148, "Das Leben so sehen, wie Gott es sieht", false),
                new Talk(149, "Unseren Weg mit Gott gehen", false),
                new Talk(150, "Ist die heutige Welt zum Untergang verurteilt?"),
                new Talk(151, "Jehova ist seinem Volk „eine sichere Zuflucht“", false),
                new Talk(152, "Das wahre Armageddon – warum und wann?"),
                new Talk(153, "Den „Ehrfurcht einflößenden Tag“ fest im Sinn behalten!"),
                new Talk(154, "Die Menschenherrschaft - auf der Waage gewogen", false),
                new Talk(155, "Ist für Babylon die Stunde der Urteilsvollstreckung gekommen?", false),
                new Talk(156, "Der Gerichtstag – Grund zur Angst oder zur Hoffnung?"),
                new Talk(157, "Wahre Christen lassen Gottes Lehren anziehend wirken", false),
                new Talk(158, "Seien wir mutig und vertrauen wir auf Jehova", false),
                ...
                new Talk(163, "Warum sollten wir Ehrfurcht vor dem wahren Gott haben?", false),
                new Talk(164, "Ist Gott noch Herr der Lage?", false),
                new Talk(165, "Wessen Wertvorstellungen teilen wir?", false),
                new Talk(166, "Mit Glauben und Mut in die Zukunft blicken"),
                new Talk(167, "Vernünftig handeln in einer unvernünftigen Welt", false),
                new Talk(168, "Sicherheit in einer unruhigen Welt", false),
