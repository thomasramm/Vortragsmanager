...
namespace Vortragsmanager.Views
{
    public class RednerEintragenView : ViewModelBase
    {
        ...
        public List<Conregation> Versammlungen => Core.DataContainer.Versammlungen.OrderBy(x => x.Name).ToList();
        ...
        public Conregation SelectedVersammlung
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    Redner = Core.DataContainer.Redner.Where(x => x.Versammlung == _selectedVersammlung).OrderBy(x => x.Name).ToList();
                    SelectedRedner = null;
                }
            }
        }
